...
M92 X200.00 Y200.00 Z200.00 E183.65:183.65              ; set steps per mm
...
G31 P500 X0 Y0 Z-0.595                                  ; Z-0.25 CF ARMS and Z-0.4 for Injection molded arms, set Z probe trigger value, offset and trigger height
...
; Retraction
//M207 S7 F4200                                           ; Set firmware retraction to 7mm at 70mm/s (untuned)
M207 S0.8 F4200                                         ; Set firmware retraction to 0.8mm at 70mm/s (length-only tuned for Atomic Dark Cherry Red PETG with PA set to 0.85 at 230C)
